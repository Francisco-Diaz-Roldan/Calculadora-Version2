...
public class Constantes {
    ...
    public static final char CHAR_MENOS = '-';
    public static final char CHAR_MULTIPLICACION = 'x';
    public static final char CHAR_DIVISION = '/';
    public static final char CHAR_POTENCIA = '^';
    public static final char CHAR_RAIZ = '√';
